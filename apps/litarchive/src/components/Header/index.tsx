...
export default function Header() {
	...
	return (
		<div className="border-border border-dashed bg-background/35 sticky top-0 z-50 !m-0 grid w-full shrink-0 grow-0 self-center rounded-none border-b backdrop-blur-lg lg:inset-0 lg:top-3 lg:m-auto lg:w-fit lg:rounded-[30px] lg:border !p-1">
