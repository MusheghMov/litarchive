...
export const metadata: Metadata = {
  ...
  description: "Join the leading community-driven storytelling platform. Write, collaborate in real-time, and monetize your stories. Start your literary journey with thousands of creators worldwide.",
  keywords: [
  ...
  twitter: {
    ...
    title: "LitArchive - Create, Collaborate & Monetize Your Stories",
    description: "Join the leading community-driven storytelling platform. Write, collaborate in real-time, and monetize your stories.",
    site: "@LitArchive",
    creator: "@Mushegh_M",
    images: [
      {
...
export default function RootLayout({
  ...
  const organizationSchema = {
    ...
    "description": "Community-driven storytelling platform where creators write, collaborate, and monetize their stories",
    "foundingDate": "2024",
    "sameAs": [
      "https://twitter.com/LitArchive",
    ],
    "contactPoint": {
      "@type": "ContactPoint",
